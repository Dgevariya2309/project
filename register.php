    ...
    <div class="register popup modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" action="login_register.php" method="POST">
            ...
            <div class="modal-body">
                ...
                <input type="number" placeholder="Age" name="age" size="4" min="18" required>
                ...
                <input type="mobile" placeholder="Mobile No"  name="mno" required>
                <input type="text" placeholder="Adhar Card No"   max="12" name="adno" required minlength="12" maxlength="12">
            </div>
