...
if (isset($_POST['gujarati'])) {
    $GLOBALS['filtered'] = true;
    $GLOBALS['value'] = "Gujarati";
    $result = display();
    $myHeaderClass6 = "active";
    $myHeaderClass1 = "";
}

if (isset($_POST['berages'])) {
    $GLOBALS['filtered'] = true;
    $GLOBALS['value'] = "Beverages";
    $result = display();
    $myHeaderClass6 = "active";
    $myHeaderClass1 = "";
}
...
<!-- < !-- ----------------------------------- South Indian-------------------------- -->
    <div class="container speciality-class box-shadow-all">
        ...
        <input type="submit" class="<?= $myHeaderClass6 ?> b6 food-btn box-shadow-all " name="gujarati" value="Gujarati" />
        <input type="submit" class="<?= $myHeaderClass6 ?> b6 food-btn box-shadow-all " name="beverages" value="Beverages" />
